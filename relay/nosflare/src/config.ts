...
// Pay-to-relay is retained only as dormant upstream code. No paid offer is launched.
...
// NIP-42 Authentication - required for recipient-scoped candidate access
...
export const relayInfo: RelayInfo = {
	...
	description:
		'Development candidate; no Cloud subscription, retention guarantee, or SLA is launched.',
