# nip46-bunker Specification

## Purpose
Define the bounded local NIP-46 signer prototype and encrypted request/response contracts that support sovereign Redshift CLI workflows without claiming Teams or production custody.
## Requirements
