# secret-state Specification

## Purpose
Define authenticated ownership, deterministic version selection, rollback protection, and logical deletion for encrypted Redshift state.
## Requirements
